...
namespace laba7
{
    class myFraction : IFormattable, IComparable<myFraction>, IConvertible
    {
        ...
        {
            if (obj == null) throw new Exception("Mistake");
            long o2 = obj.numerator / Convert.ToInt64(obj.denominator);
            long o1 = this.numerator / Convert.ToInt64(this.denominator);
        ...
        public static bool operator <=(myFraction first, myFraction second)
        {
            if (first.CompareTo(second) == 1 || first.Equals(second) == true)
                return true;
            return false;
        }
        ...
        public static implicit operator double(myFraction temp)
        {
             return Convert.ToDouble(temp.numerator) / temp.denominator;
        }
        ...
        public static implicit operator long(myFraction temp)
        {
